...
<div id="welcome-bg"
     class="relative min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden"
    ...
    <div class="absolute top-4 right-4 z-20">
        <button onclick="toggleTheme(); updateWelcomeBg();"
    ...
    <div class="relative z-10 text-center max-w-2xl w-full">
        ...
        <p class="text-purple-200 text-xl mb-10">Laravel · Livewire · Alpine.js · Tailwind</p>
        ...
        <div class="flex flex-wrap gap-3 justify-center mt-14">
            @foreach(['✅ Laravel '.app()->version(), '✅ Livewire 3', '✅ Alpine.js', '✅ Tailwind v3'] as $tech)

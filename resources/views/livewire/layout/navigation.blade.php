<nav x-data="{ open: false }" class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <span class="text-xl font-black text-indigo-700 dark:text-indigo-400">Duardo</span>
                    </a>
                </div>
                <!-- Nav links -->
            ...
            <!-- Right: toggle + user dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">

                {{-- Toggle dark/light usando JS puro (no Alpine store) --}}
                <button
                    onclick="toggleDarkMode()"
                    class="w-10 h-10 flex items-center justify-center rounded-xl transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400"
                    title="Cambiar tema"
                >
                    {{-- Sol: visible en dark mode --}}
                    <svg id="icon-sun" style="display:none;" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                <button onclick="toggleDarkMode()" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-left text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                    🌙/☀️ Cambiar tema
                </button>

        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                ...
                <button
                    ...
                    class="relative w-10 h-10 flex items-center justify-center rounded-xl transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400"
                    title="Cambiar tema"
                >
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                ...
                <button @click="$store.theme.toggle()" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                    <span x-text="$store.theme.dark ? '☀️ Modo claro' : '🌙 Modo oscuro'"></span>
                </button>
